...
double screen(double P1, double P2) {
    return round(1.0 - (1.0 - P1) * (1.0 - P2));
}

// Subtract
double subtract(double P1, double P2) {
    return round(std::max(0.0, P1 - P2));  // Ensure the result is not less than 0
}

// Addition
double addition(double P1, double P2) {
    return round(std::min(1.0, P1 + P2));  // Ensure the result is not more than 1
}
...
double overlay(double P1, double P2) {
    if (P2 <= 0.5) {
        ...
        return round(1.0 - 2.0 * (1.0 - P1) * (1.0 - P2));
    }
}
